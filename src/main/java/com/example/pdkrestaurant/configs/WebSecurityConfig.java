package com.example.pdkrestaurant.configs;

import com.example.pdkrestaurant.securities.JwtAuthenticationEntryPoint;
import com.example.pdkrestaurant.securities.JwtTokenFilter;
import com.example.pdkrestaurant.securities.UserAuthenticationProvider;
...
public class WebSecurityConfig {
    ...
    private final List<String> pattern = Arrays.asList(
            ...
            "/pdkrestaurant/**",
            "pdkrestaurant/dichvu",
            "pdkrestaurant/loaiban",
            "pdkrestaurant/datban"
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/pdkrestaurant/**").permitAll()
